  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        leading: IconButton(
          icon: Image.asset('assets/home.png'), // Replace menu icon with home icon
          onPressed: () {
        ...
        children: [
          ...
          Center(
            child: Row(
              ...
              children: [
                buildIconTile('assets/icon1.png', bgcolor),
                const SizedBox(width: 10), // Spacing between the icons
                buildIconTile('assets/icon3.png', bgcolor),
              ],
            ),
          ),
        ],
